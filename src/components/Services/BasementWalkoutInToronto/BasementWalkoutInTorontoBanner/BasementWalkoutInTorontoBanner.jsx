  ...
  return (
    <div>
      ...
      <div className="hidden md:block">
        <div className="banner__bg py-[75px] lg:py-[88px] xl:py-[101px] 2xl:py-[114px] 3xl:py-[127px] 4xl:py-[140px] 5xl:py-[158px]">
          <div className="container h-full flex flex-col items-start justify-center">
            <h1 className="text-[34px] lg:text-[38px] xl:text-[42px] 2xl:text-[46px] 3xl:text-[50px] 4xl:text-[52px] 5xl:text-[55px] font-bold text-white leading-normal">
              Basement Walkout <br /> in Toronto
            </h1>
            <p className="text-lg font-normal text-white leading-normal">
              Transform your basement into a convenient and accessible space
              with
              <br className="hidden md:block" /> basement walkout installation
              services from Prime Basement
              <br className="hidden md:block" /> Renovations in Toronto.
            </p>
      ...
      <div className="container h-full flex flex-col items-start justify-center">
        ...
        <p className="text-lg font-normal text-white leading-normal">
        Transform your basement into a convenient and accessible space with
          <br className="hidden md:block"/> basement walkout installation services from Prime Basement
          <br className="hidden md:block" /> Renovations in Toronto.
        </p>
        <div className="mt-[35px]">
          <button className="flex items-center gap-[10px] py-[15px] px-[12px] text-base font-bold text-white leading-normal rounded-[8px] bg-primary-700">
