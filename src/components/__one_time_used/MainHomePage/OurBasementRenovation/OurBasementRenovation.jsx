      ...
      <div data-aos="zoom-in" className="container padding__top">
        ...
        <div className="flex justify-center items-center my-[25px]">
          <buttton className="btn__first text-[20px] 5xl:text-[25px] font-bold leading-normal text-white text-center py-[4px] md:py-[10px] 5xl:py-[17px] px-[50px] lg:px-[140px] 5xl:px-[170px]">
            Our Basement Renovation Contractors Do's
          </buttton>
        </div>
        ...
        {/* second part  */}
        <div className="w-full flex flex-col md:flex-row justify-center mt-[15px] gap-[15px]">
            <div className="w-full md:w-1/3 how_we_cart___bg pt-[14px] pb-[21px] px-2">
              <p className="text-[22px] 5xl:text-[25px] text-center font-bold text-black leading-normal">
              Do Communicate Regularly
              </p>
              <p className="text-lg font-normal text-black leading-[35px] text-center">
              Keep in touch with your contractor throughout the renovation. Open communication helps avoid misunderstandings and ensures that the project stays on track.
              </p>
            </div>
            <div className="w-full md:w-1/3 how_we_cart___bg pt-[14px] pb-[21px] px-2">
              <p className="text-[22px] 5xl:text-[25px] text-center font-bold text-black leading-normal">
              Do Consider Insulation and Ventilation
              </p>
              <p className="text-lg font-normal text-black leading-[35px] text-center">
              Proper insulation and ventilation are essential for comfort and energy efficiency in your finished basement. Our team can advise on the best solutions for your space.
              </p>
            </div>
          </div>
        ...
        <div className="flex justify-center items-center my-[25px]">
          <buttton className="btn__second text-[20px] 5xl:text-[25px] font-bold leading-normal text-white text-center py-[4px] md:py-[10px] 5xl:py-[17px] px-[50px] lg:px-[140px] 5xl:px-[170px]">
            Our Basement Renovation Contractors Don'ts
          </buttton>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[15px]">
        ...
        <div className="w-full flex flex-col md:flex-row justify-center mt-[15px] gap-[15px]">
            <div className="w-full md:w-1/3 how_we_cart___bg pt-[14px] pb-[21px] px-2">
              ...
              <p className="text-lg font-normal text-black leading-[35px] text-center">
              Address any potential structural issues before beginning the renovation. Neglecting these concerns can compromise the safety and longevity of your finished basement.
              </p>
            </div>
            <div className="w-full md:w-1/3 how_we_cart___bg pt-[14px] pb-[21px] px-2">
              <p className="text-[22px] 5xl:text-[25px] text-center font-bold text-black leading-normal">
              ...
              <p className="text-lg font-normal text-black leading-[35px] text-center">
              Basement renovations take time, and rushing the process can lead to mistakes. Patience and careful craftsmanship are key to achieving the best possible outcome.
              </p>
            </div>
          </div>
      </div>
