  ...
  return (
    <div>
      ...
      <div className="hidden md:block">
        <div className="lg_banner__bg py-[62px] md:py-[75px] lg:py-[88px] xl:py-[101px] 2xl:py-[114px] 3xl:py-[127px] 4xl:py-[140px] 5xl:py-[158px]">
          <div className="container h-full flex flex-col items-start justify-center">
            ...
            <p className="text-lg font-normal text-white leading-normal">
              ...
              <br className="hidden md:block" /> Toronto, enhancing your home
              with style, function, and quality{" "}
      ...
      <div className="block md:hidden">
        <div className="sm_banner__bg px-[24px] sm:px-[30px] py-[62px]">
