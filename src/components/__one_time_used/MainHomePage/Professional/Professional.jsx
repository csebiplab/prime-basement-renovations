        ...
        <div className='full__section_l_p pr-3 md:pr-0 padding__top'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[15px] xl:gap-[36px]'>
                ...
                <div data-aos="fade-right" className='order-2 md:order-1 md:col-span-1'>
                    ...
                    <p className='text-lg font-normal leading-[35px] text-black text-center md:text-left mt-[5px] md:mt-[10px]'>At Prime Basement Renovations, we pride ourselves on being a professional basement renovation contractor in Toronto dedicated to transforming your basement into a beautiful and functional space. We understand that renovating a basement can be a significant investment, so we prioritize quality and craftsmanship in every detail. Our contractors are well-versed in the latest building codes and <Link className="hover:underline" rel="nofollow" target="_blank" href="https://en.wikipedia.org/wiki/Construction">construction</Link> techniques, allowing us to create safe, durable, and stylish spaces that enhance your home's value.
